...
###### 10. What are the three phases of event propagation?
...
###### 19. How long is cool_secret accessible?
...
###### 22. The JavaScript global execution context creates two things for you: the global object, and the "this" keyword.
...
###### 27. What is the event.target when clicking the button?
...
###### 28. When you click the paragraph, what's the logged output?
...
###### 31. Which of these values are falsy?
...
###### 34. Everything in JavaScript is either a...
...
###### 36. What does the `setInterval` method return in the browser?
...
###### 56. With which constructor can we successfully extend the `Dog` class?
...
###### 74. What kind of information would get logged?
...
###### 75. Which option is a way to set `hasName` equal to `true`, provided you cannot pass `true` as an argument?
